import { CREATE, FETCHALLSKILLS, LOADING, END_LOADING, SET_SKILL, DELETESKILL, UPDATESKILL } from '../constants/actionTypes';export default (state = { skills: [], loading: false, endLoading: false, currentSkill: null }, action) => {
  switch (action.type) {
    case LOADING:
    ...
    case CREATE:
      return { ...state, skills: [...state, action.payload] };
    case SET_SKILL:
